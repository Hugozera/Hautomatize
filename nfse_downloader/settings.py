...
SECRET_KEY = 'django-insecure-%7p7!9i8*a&7z@d_v^en_htbf+08&jt9j2sgx'
DEBUG = True
# Permite conexões locais na rede durante desenvolvimento
ALLOWED_HOSTS = ['*']
...
# CONFIGURAÇÃO SIMPLES DE TEMPLATES - QUE FUNCIONA!
TEMPLATES = [
    {
